<div>
  <div>Seegle LLC Terms and Conditions</div>
  <div>
    ...
    <p>
      Welcome to <b>Seegle, LLC</b> (“Company”, “we”, “our”, “us”)!
    </p>
    <p>
      These Terms of Service (“Terms”, “Terms of Service”) govern your use of our app, Seegle, for
      Android and iOs (together or individually “Service”) operated by <b>Seegle, LLC</b>.
    </p>
    <p>
    ...
    <p>
      ...
      <b>support@seegle.app</b> so we can try to find a solution. These Terms apply to all visitors,
    ...
    <p>
      ...
      (you own it) and/or you have the right to use it and the right to grant us the rights and
    ...
    <p>
      Seegle, LLC has the right but not the obligation to monitor and edit all Content provided by
      users.
    </p>
    <p>
      In addition, Content found on or through this Service are the property of Seegle, LLC or used
    ...
    <p>
      Service is intended only for access and use by individuals at least thirteen (13) years old.
      By accessing or using Service, you warrant and represent that you are at least thirteen (13)
      years of age and with the full authority, right, and capacity to enter into this agreement and
      abide by all of the terms and conditions of Terms. If you are not at least thirteen (13) years
    ...
    <p>
      When you create an account with us, you guarantee that you are above the age of 13, and that
    ...
    <p>
      ...
      functionality are and will remain the exclusive property of Seegle, LLC and its licensors.
    ...
    <p>
      ...
      submit your claim via email to support@seegle.app, with the subject line: “Copyright
    ...
    <p>You can contact our Copyright Agent via email at support@seegle.com.</p>
    <p>
      12. <b>Error Reporting and Feedback</b>
    </p>
    <p>
      You may provide us either directly at support@seegle.app or via third party sites and tools
    ...
    <p>
      ...
      controlled by Seegle, LLC.
    </p>
    <p>
      Seegle, LLC has no control over, and assumes no responsibility for the content, privacy
    ...
    <p>
      These Terms shall be governed and construed in accordance with the laws of Idaho, United
      States, which governing law applies to agreement without regard to its conflict of law
      provisions.
    </p>
    <p>
    ...
    <p>
      We may amend Terms at any time by posting the amended terms here. It is your responsibility to

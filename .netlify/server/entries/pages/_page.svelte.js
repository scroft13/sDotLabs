import { c as create_ssr_component, d as add_attribute, t as tick, g as getContext, s as setContext, o as onDestroy, f as compute_rest_props, b as subscribe, l as listen, h as bubble, p as prevent_default, i as stop_propagation, j as get_current_component, k as spread, q as escape_object, v as validate_component, m as missing_component, r as createEventDispatcher, u as each, e as escape } from "../../chunks/index.js";
...
const Resume = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"absolute flex w-full text-secondary justify-between top-0 px-4 pt-4 max-w-full z-[1]"}"><button class="${"p-2 text-primary border-primary border rounded disabled:disabled-text disabled:disabled-border"}" ${"disabled"}>Previous Page</button>
  <button class="${"p-2 text-primary border-primary border rounded disabled:disabled-text disabled:disabled-border"}" ${pageNum === totalPages ? "disabled" : ""}>Next Page</button></div>
<div class="${"relative h-full overflow-x-auto w-full bg-primary"}"><canvas class="${"w-[1100px] overflow-clip mb-1"}"${add_attribute("this", canvas, 0)}></canvas></div>`;
});
var State;
(function(State2) {
...
const SideMenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(TransitionRoot, "TransitionRoot").$$render($$result, { as: "div", show: sideMenuIsOpen }, {}, {
    ...
    ${validate_component(TransitionChildWrapper, "TransitionChild").$$render(
            ...
            {
              default: () => {
                return `<div class="${"px-4 pt-5 pb-2 flex justify-end"}"><button type="${"button"}" class="${"-m-2 p-2 rounded-md inline-flex items-center justify-center text-white"}"><span class="${"sr-only"}">Close menu</span>
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let descriptorArray = ["Web Developer", "Father", "12th Man", "Code Monkey", "Mariners Fan"];
...
<div class="${"fixed flex w-full items-center h-12 justify-center bg-white "}"><div class="${"fixed flex justify-between w-full max-w-lg px-4"}"><a href="${"/"}" class="${""}">Home </a>
    <a href="${"#resume"}" class="${""}">Resume </a>
    <a href="${"#contact"}" class="${""}">Contact</a></div></div>
<div class="${"snap-both"}"><div class="${"flex flex-col items-center justify-center h-[100vh] snap-center snap-proximity shrink-0"}"><img${add_attribute("src", imgSrc, 0)} alt="${""}" class="${"w-4/5 lg:w-1/3 aspect-auto rounded-full"}">
    <div class="${"w-full text-center flex flex-col"}"><h1>Hello, my name is Shaun Croft</h1>
      <div class="${"text-left flex w-full items-center justify-center self-start"}">I am a \xA0
        <div class="${"px-3 flex border-b-2"}"><div class="${"whitespace-nowrap"}">${each(descriptorArray, (descriptor, index) => {
      return `<p>${index == currentDescriptorIndex ? `${escape(descriptor)}` : ``}
              </p>`;
    })}</div></div></div></div></div>
  <div id="${"resume"}" class="${"flex h-[100vh] snap-center w-full items-center justify-center shrink-0"}">${validate_component(Resume, "Resume").$$render($$result, { url: "/resume.pdf" }, {}, {})}</div>
  <div id="${"contact"}" class="${"flex h-[100vh] snap-center w-full items-center justify-center shrink-0"}">Contact
  </div></div>`;
  } while (!$$settled);
  return $$rendered;
});
